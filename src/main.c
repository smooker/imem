...
uint8_t w2[16] = {0x80, 0x80, 0x40, 0x34, 0x49, 0x34, 0x4b, 0x30, 0x50, 0x45, 0x31, 0x41, 0x4C, 0x50, 0x45};
//                                   4     I     4     K     0     P     E     1     A     L     P     E
uint8_t w3[16] = {0x80, 0xc0, 0x40, 0x50, 0x45, 0x44, 0x41, 0xcd, 0x4C, 0xcd, 0x32, 0x41, 0x4C, 0xcd, 0xcd};
//                                   P     E     D     A     *     L     *     2     A     L     *     *
uint8_t w4[14] = {0x80, 0x80, 0x80, 0x40, 0x40, 0x1f, 0x1f, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00};
//                                          |    |     |     |     | UN: X X X REL3 LN: X X X steady hold
//                                          |    |     |     | UN: X X X READY LN: X X DOT SETUP
//                                          |    |     | UN : X X X CAL LN: off ATC MTC ERR
//                                          |    | UN bit 0 - steady meas LN - symbols
//                                          | ugasvat redove
//
//
